/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f44828ccc6f5e75dc2d09d86cd4b9a39)
...
interface __BaseEnv_CloudflareEnv {
	...
	REFILL_RATE_LIMIT: RateLimit;
	RANKING_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	BETA_MODE: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETA_MODE" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ADMIN_EMAILS">> {}
}
